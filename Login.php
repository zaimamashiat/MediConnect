    ...
    <section class="skrollable u-clearfix u-image u-shading u-section-1" id="sec-7deb" data-image-width="1100" data-image-height="731">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <div class="u-form u-login-control u-form-1">
          <form action=".Doctor-or-Patient.php" class="u-clearfix u-form-custom-backend u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 10px;" redirect="true" method="post">
            ...
            <div class="u-form-group u-form-password">
              ...
              <input type="text" placeholder="Enter your Password" id="password-a30d" name="password" class="u-input u-input-rectangle u-none u-input-2" required="">
            </div>
